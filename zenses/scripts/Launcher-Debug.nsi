...
; Icon "Zenses2.ico"
OutFile "Zenses2 Beta1 Debug.exe"
 
VIAddVersionKey "ProductName" "Zenses2 Beta1 (Debug)"
VIAddVersionKey "Comments" ""
VIAddVersionKey "CompanyName" "Sixones"
VIAddVersionKey "LegalTrademarks" ""
VIAddVersionKey "LegalCopyright" "Sixones"
VIAddVersionKey "FileDescription" "Zenses2 Beta1 (Debug)"
VIAddVersionKey "FileVersion" "2.0.1b1"
VIProductVersion "2.0.1.0b1"
...
Section ""
  ...
  ${GetParameters} $1
  StrCpy $0 '"$R0" -Djava.library.path=lib\ -classpath "${CLASSPATH}" ${CLASS} $1'
